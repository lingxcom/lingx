 ...
 */
@Component
public class CommentWorkflow implements IWorkflowMethod {
	...
	public String execute(IWorkflow workflow, IContext context,
		...
		Map<String,Object> ret=this.workflowService.comment(workflow.getTaskId(), workflow, context, performer);
