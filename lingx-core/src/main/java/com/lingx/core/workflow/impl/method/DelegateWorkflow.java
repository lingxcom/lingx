 ...
 * @version 创建时间：2015年11月2日 下午9:56:04 
 * 类说明 
 */
@Component
public class DelegateWorkflow implements IWorkflowMethod{
	...
	public String execute(IWorkflow workflow, IContext context,
		...
		Map<String,Object> ret=this.workflowService.delegate(workflow.getTaskId(), workflow, context, performer);
