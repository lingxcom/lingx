 ...
 */
@Component
public class IsValidWorkflow implements IWorkflowMethod {
	...
	public String execute(IWorkflow workflow, IContext context,
		...
		Map<String,Object> ret=this.workflowService.isvalid(workflow.getTaskId(), workflow, context, performer);
