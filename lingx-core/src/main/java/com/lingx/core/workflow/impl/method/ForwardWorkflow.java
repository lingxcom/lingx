 ...
 */
@Component
public class ForwardWorkflow implements IWorkflowMethod {
	...
	public String execute(IWorkflow workflow, IContext context,
		...
		Map<String,Object> ret=this.workflowService.forward(workflow.getTaskId(), workflow, context, performer);
